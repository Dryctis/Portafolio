...
export default function TubelightHero({
  ...
  return (
    ...
    >
      ...
      <FloorReflection color={glowColor} strength={1.2} className="z-[1]" />

      <motion.div style={{ x, y }} className="relative z-[2]">
        <motion.div
          ...
          animate={prefersReduced ? { opacity: 0.85 } : { opacity: [0.65, 0.95, 0.75] }}
          transition={
            prefersReduced
              ? { duration: 0.4 }
